import http from "http"; // nodemon touch
...
// Prevent crashes on unhandled errors during development; log and keep server alive for /health
...
app.get("/health", async (req, res) => {
  ...
  res.status(healthy ? 200 : 503).send(payload);
});
